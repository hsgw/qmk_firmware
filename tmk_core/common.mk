...
ifeq ($(PLATFORM),CHIBIOS)
  ...
  ifeq ($(strip $(EEPROM_EMULATION_ENABLE)), yes)
  ...
  else ifeq ($(strip $(EXTERNAL_EEPROM_ENABLE)), yes)
      TMK_COMMON_DEFS += -DEXTERNAL_EEPROM_ENABLE
      TMK_COMMON_SRC += $(PLATFORM_COMMON_DIR)/eeprom_ext.c
  else
