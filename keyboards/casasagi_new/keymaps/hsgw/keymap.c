...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
        ...
        KC_LALT, KC_LALT, KC_LALT, KC_LGUI, JP_ZKHK, NUM_SPC, KC_TAB,         FUNC_ENT, FUNC_ENT,KC_BSPC, JP_LBRC,   JP_RBRC,   JP_BSLS,   JP_YEN\
    ),
    [NUM] = LAYOUT(
    ...
    [CONF] = LAYOUT(
        QK_BOOT, RGB_TOG, RGB_HUI, XXXXXXX, XXXXXXX, XXXXXXX, EE_CLR,         EE_CLR,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_TOG, QK_BOOT, \
