...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NUM] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,            KC_PSCR, _______, JP_LBRC, JP_RBRC, _______,  _______, \
    ...
    [CONF] = LAYOUT(
        RESET,   EEPROM_TEST, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    ...
    switch(keycode) {
        case EEPROM_TEST:
            if(record->event.pressed) {
                char temp = eeprom_read_byte((uint8_t*)36);
                send_char(temp+'a');
                temp++;
                if(temp==10) temp=0;
                eeprom_write_byte((uint8_t*)36, temp);
            }
    }
    return true;
}
