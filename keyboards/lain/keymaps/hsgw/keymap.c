...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_LALT,                   KC_LGUI, CTL_ZH,  NUM_SPC, TT(XKEY),  KC_ENT, KC_BSPC, MO(FUNC),KC_MENU, JP_CIRC,  JP_BSLS\
    ),
    [NUM] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,            WIN_PS,  JP_LBRC, JP_RBRC, S(JP_COMM),S(JP_DOT), _______, \
        _______,                   _______, _______, _______, _______,   _______, _______, _______, _______,   _______,  _______ \
    ),
    [FUNC] = LAYOUT(
        _______,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, \
        _______, _______, _______, _______, _______, _______, _______,    _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, \
