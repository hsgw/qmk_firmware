...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_LALT,                   KC_LGUI, SFT_ZK, NUM_SPC,  KC_TAB,  FUNC_ENT, KC_BSPC, MO(FUNC),JP_YEN,  JP_CIRC,  JP_BSLS\
    ),
    [NUM] = LAYOUT(
        ...
        _______, C(KC_Z), VS_FMT,  C(KC_C), C(KC_V), WIN_PS,             VS_FMT,  JP_LBRC, JP_RBRC, S(JP_COMM),S(JP_DOT), _______, \
