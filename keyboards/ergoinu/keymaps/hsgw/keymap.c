...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                     KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RO,    KC_RSFT, \
                               KC_LALT, KC_LGUI, META_ZK, KC_BSPC, KC_SPC,  KC_ENT, KC_BSPC, MO(META), ______,   ______ \
  ),
  ...
  [META] = LAYOUT( \
    ...
    ______,           ______,  ______,  ______,  ______,  TD(TD_LBRT),               KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, ______, KC_PGUP,  KC_PGDN, \
