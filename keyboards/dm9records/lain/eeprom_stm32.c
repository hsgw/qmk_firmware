 ...
 *
 * Original file is taken from https://github.com/qmk/qmk_firmware/blob/f4094930a393ec3dc597e06e95cd3365e3f8cb97/tmk_core/common/chibios/eeprom_stm32.c
 *
 */
...
uint8_t _eeprom_read_byte (const uint8_t *Address)
{
...
void _eeprom_write_byte (uint8_t *Address, uint8_t Value)
{
