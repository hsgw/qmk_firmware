...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                       KC_N,    KC_M,    JP_COMM, JP_DOT, JP_SLSH,  JP_BSLS,\
                          KC_LALT, KC_LGUI, SFT_ZK, NUM_SPC, KC_TAB,    KC_ENT, KC_BSPC, MO(FUNC),JP_LBRC, JP_RBRC\
    ),
    [NUM] = LAYOUT(
        ...
        _______, C(KC_Z), VS_FMT,  C(KC_C), C(KC_V), WIN_PS,                     KC_INS,   _______, S(JP_COMM),S(JP_DOT), S(JP_SLSH),JP_CIRC, \
                          _______, _______, _______, _______, _______,   _______, _______, _______, S(JP_LBRC),S(JP_LBRC) \
    ),
    [FUNC] = LAYOUT(
