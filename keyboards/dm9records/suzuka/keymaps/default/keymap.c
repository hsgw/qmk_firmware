...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    JP_AT,   JP_LBRC, KC_ENT,             KC_DEL,  KC_END,  KC_PGDN,
        ...
        KC_LCTL, KC_LGUI, KC_LALT, FN_TAB,  KC_SPC,                KC_SPC,  KC_BSPC, KC_RGUI, KC_RALT, KC_MENU, KC_RCTL,                              KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN] = LAYOUT(
        RESET,            _______, _______, _______, _______,      RESET,   _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______,
